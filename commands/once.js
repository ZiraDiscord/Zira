    ...
    if (!command.params[0] || !command.params[1]) {
      ...
      caller.utils.message(command.msg.channel.id, {
        embed: {
          ...
          title: lang.title,
          description: `**${command.prefix}${lang.once.help}\n\n${lang.example}${command.prefix}once :information_source: Updates\n${command.prefix}once :information_source: Updates, <:thirp:450747331512369152> <@&${ROLES[caller.utils.randomNumber(0, ROLES.length - 1)].id}>\n[${lang.guide}](https://zira.pw/guide/once)`,
        },
      }).catch(console.error);
      return;
    }
